...
sequenceDiagram
    ...
    S->>S: Process request
    S-->>C: Response (e.g., x=2.5, y=1.3, θ=45°)
```
...
- ⚠️ **Not for streaming**: Services are for one-shot requests
...
👉 **[Nodes, Topics, and Services](/docs/ros2-fundamentals/nodes-topics-services)** — Hands-on implementation
