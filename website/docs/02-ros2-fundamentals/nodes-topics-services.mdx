...
✅ **Nodes are processes**: Each does one thing well
✅ **Topics for streaming**: Sensor data, robot state
✅ **Services for requests**: One-shot commands, queries
✅ **Use CLI tools**: Debug with `ros2 topic`, `ros2 service`, `ros2 node`
✅ **Follow best practices**: Namespaces, error handling, timers
...
👉 **[Building ROS 2 Packages](/docs/02-ros2-fundamentals/building-packages)** — Create reusable packages
