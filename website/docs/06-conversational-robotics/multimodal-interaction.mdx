...
**Next**: [Hardware Requirements](../hardware-requirements/) - Explore the hardware needed for humanoid robotics.

**Previous**: [Speech Recognition](./speech-recognition) - Build voice interfaces for robots.