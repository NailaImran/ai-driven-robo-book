...
✅ **LLMs are powerful task planners**—decompose "make coffee" into steps
✅ **Multimodal = vision + language**—ground words in percepts
✅ **Real-time matters**—streaming speech recognition, not batch
✅ **Context is critical**—remember previous conversation turns
✅ **Fallback strategies**—handle misunderstood commands gracefully

---

## What's Next?

👉 **[Capstone Project](/docs/09-capstone/)** — Build an autonomous humanoid system integrating all modules
