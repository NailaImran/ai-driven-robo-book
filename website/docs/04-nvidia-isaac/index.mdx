...
- Importing robots (URDF → USD format)
...
✅ **GPUs accelerate robotics**—perception, planning, and learning all benefit
✅ **Isaac Sim → photorealism**—train vision models on synthetic data
✅ **Isaac Gym → parallel RL**—train in hours, not days
✅ **Jetson → edge deployment**—run models where the robot is
✅ **Sim-to-real works**—with domain randomization and careful tuning

---

## What's Next?

👉 **[Module 4: Humanoid Development](/docs/05-humanoid-development/)** — Kinematics, dynamics, and bipedal locomotion
