...
✅ **Kinematics is fundamental**—FK for simulation, IK for task planning
✅ **Jacobians enable velocity control**—smooth, real-time motion
✅ **ZMP keeps robots upright**—critical for bipedal locomotion
✅ **Whole-body control is hard**—many DOF, many constraints
✅ **Simulation first**—test gaits before deploying to hardware

---

## What's Next?

👉 **[Week 13: Conversational Robotics](/docs/conversational-robotics/)** — Natural language interaction with LLMs
