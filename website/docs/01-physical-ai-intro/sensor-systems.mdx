...
|------------|-------|---------|------------|------|
| **Stereo** | 1-50m | ✅ Yes | High | Low |
| **Structured Light** | 0.3-3m | ❌ No | Medium | Medium |
| **ToF** | 0.5-5m | 🟡 Limited | Low | High |
...
# Fuses IMU + odometry + GPS → /odometry/filtered
```
...
**Previous**: [← Humanoid Robotics Landscape](./humanoid-landscape) | **Next**: [Module 1: ROS 2 Fundamentals →](../ros2-fundamentals/)
