...
👉 **[Learning Outcomes](/docs/00-introduction/learning-outcomes)** — Detailed skills you'll master

👉 **[Why Physical AI?](/docs/00-introduction/why-physical-ai)** — The future of embodied intelligence

👉 **[Week 1-2: Physical AI Intro](/docs/01-physical-ai-intro/)** — Start the journey!
